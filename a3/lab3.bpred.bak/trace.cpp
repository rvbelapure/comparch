...
VOID get_ld_ea(ADDRINT addr, UINT32 mem_read_size){	/* DO NOT MODIFY */
  g_vaddr = addr;
  g_mem_read_size = mem_read_size;
}

VOID get_st_ea(ADDRINT addr, UINT32  mem_st_size){	/* DO NOT MODIFY */
  g_st_vaddr = addr;
  g_mem_write_size = mem_st_size;
}

VOID get_target(ADDRINT target, bool taken){		/* DO NOT MODIFY */
  g_target = target;
...
void ins_decode(INS ins, gzFile stream) 		/* DO NOT MODIFY */
{
...
VOID write_inst(ADDRINT iaddr)				/* DO NOT MODIFY */
{
...
VOID dprint_inst(ADDRINT iaddr, string *disassemble_info) {		/* DO NOT MODIFY */
  Trace_op *trace_op = inst_storage[iaddr]; 
...
void copy_trace_op(Trace_op *trace_op, Op *op)			/* DO NOT MODIFY */
{
...
void init_trace_op(Trace_op *trace_op)			/* DO NOT MODIFY */ 
{
  trace_op->num_src               = 0; 
  trace_op->src[0]                = -1; 
  trace_op->src[1]                = -1;
