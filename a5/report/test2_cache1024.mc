...
Processor: 
  Area = 464.674 mm^2
  Peak Power = 29.7619 W
  Total Leakage = 8.28781 W
  Peak Dynamic = 21.4741 W
  Subthreshold Leakage = 7.28614 W
  Gate Leakage = 1.00167 W
  Runtime Dynamic = 9.26133 W

  Total Cores: 1 cores 
  Device Type= ITRS high performance device type
    Area = 329.435 mm^2
    Peak Dynamic = 10.3024 W
    Subthreshold Leakage = 4.24573 W
    Gate Leakage = 0.655443 W
    Runtime Dynamic = 9.10419 W
...
Core:
      ...
      Instruction Fetch Unit:
        Area = 153.521 mm^2
        Peak Dynamic = 4.3175 W
        Subthreshold Leakage = 1.84795 W
        Gate Leakage = 0.29115 W
        Runtime Dynamic = 5.28593 W

      Load Store Unit:
        Area = 169.077 mm^2
        Peak Dynamic = 4.28452 W
        Subthreshold Leakage = 1.84576 W
        Gate Leakage = 0.290978 W
        Runtime Dynamic = 3.39639 W

      Memory Management Unit:
        Area = 1.2133 mm^2
        Peak Dynamic = 0.251316 W
        Subthreshold Leakage = 0.0159246 W
        Gate Leakage = 0.00390473 W
        Runtime Dynamic = 0.163693 W

      Execution Unit:
        Area = 2.29564 mm^2
        Peak Dynamic = 1.44904 W
        Subthreshold Leakage = 0.202088 W
        Gate Leakage = 0.0266896 W
        Runtime Dynamic = 0.258174 W
