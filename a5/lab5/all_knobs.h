...
class all_knobs_c {
	...
	public:
		...
		KnobTemplate< unsigned> * KNOB_PERCEP_HIS_LENGTH;
		KnobTemplate< unsigned> * KNOB_PERCEP_TABLE_ENTRY;
		KnobTemplate< unsigned> * KNOB_PERCEP_CTR_BITS;
		KnobTemplate< unsigned> * KNOB_PERCEP_THRESH_OVD;
		KnobTemplate< unsigned> * KNOB_CLOCK_FREQ;
};
